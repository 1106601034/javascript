      ...
      <nav className="container-xxl bd-gutter flex-wrap flex-lg-nowrap" aria-label="Main navigation">
        ...
        <div className="d-flex">
          <div className="bd-search" id="docsearch" data-bd-docs-version="5.3">
            <button type="button" aria-label="Search (Ctrl+K)" className="DocSearch DocSearch-Button">
              <span className="DocSearch-Button-Container">
                <svg width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" className="DocSearch-Search-Icon">
                  <path
        ...
        >
          ...
          <div className="offcanvas-body p-4 pt-0 p-lg-0">
            ...
            <ul className="navbar-nav flex-row flex-wrap bd-navbar-nav">
              ...
              <li className="nav-item col-6 col-lg-auto">
                <a className="nav-link py-2 px-0 px-lg-2" href="/docs/5.3/examples/">
                  Examples
                </a>
              </li>
              <li className="nav-item col-6 col-lg-auto">
            ...
            <ul className="navbar-nav flex-row flex-wrap ms-md-auto">
              ...
              <li className="nav-item col-6 col-lg-auto">
                ...
                >
                  ...
                  <small className="d-lg-none ms-2">X</small>
                </a>
              </li>
              <li className="nav-item col-6 col-lg-auto">
                <a
              ...
              <li className="nav-item py-2 py-lg-1 col-12 col-lg-auto">
                <div className="vr d-none d-lg-flex h-100 mx-lg-2 text-white" />
              ...
              <li className="nav-item dropdown">
                ...
                >
                  <span className="d-lg-none" aria-hidden="true">Bootstrap</span>
                  <span className="visually-hidden">Bootstrap&nbsp;</span>
                  v5.3
                  <span className="visually-hidden">(switch to other versions)</span>
                </button>
                <ul className="dropdown-menu dropdown-menu-end">
                  ...
                  <li>
                    <a
                      ...
                      aria-current="true"
                      href="/docs/5.3/customize/color-modes/"
                    >
                      Latest (5.3.x)
                      <svg className="bi" aria-hidden="true">
                  ...
                  <li>
                    <div className="dropdown-item disabled">v5.2.3</div>
                  </li>
                  <li>
                    <div className="dropdown-item disabled">v5.1.3</div>
                  </li>
                  <li>
                    <div className="dropdown-item disabled">v5.0.2</div>
                  </li>
